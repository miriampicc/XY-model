...
temperatures = [0.3, 0.32, 0.35, 0.36, 0.37, 0.39, 0.4, 0.405, 0.41, 0.415, 0.42, 0.422, 0.424, 0.426, 0.428, 0.43, 0.432, 
                0.434, 0.436, 0.438, 0.44, 0.442, 0.444, 0.446, 0.448, 0.45, 0.455, 0.46, 0.465, 0.47, 0.475, 0.48, 0.49, 
                0.5, 0.51, 0.52, 0.53, 0.55, 0.56, 0.57, 0.58, 0.59, 0.6, 0.62, 0.65, 0.67, 0.7, 0.72, 0.75, 0.77, 0.8, 
                0.82, 0.85, 0.87, 0.9, 0.92, 0.94, 0.95, 0.96, 0.98, 1.0]
...
for temp in temperatures:
    ...
    file_path = f"/Users/mirimi/Desktop/hihi/KTH/XY-model/Relative_fluctuations_mod/K={K}/Output_L={L}/T_{temp}" + '/Energy.txt'
...
plt.ylabel('Energy')
plt.title(f'Relative density fluctuations, K=1 L={L} ')
plt.grid(True)
