...
plt.figure()
plt.plot(temperatures, mean_val_U,  color= 'green', label='U')
plt.fill_between(temperatures, mean_val_U - error_U, mean_val_U + error_U, alpha=0.6, facecolor='lightgreen', linewidth=4, label='Error Bounds ')
