...
for l in L:
    ...
    for n in range(rank) : 
        ...
        file_path1 = f"/home/x_mirpi/Output_TBG/K_{K}2/e_{e}/L{l}_K{K}_e{e}_bmin{beta_low}_bmax{beta_high}/beta_{n}" + '/Helicity_modulus1.txt'
        ...
        file_path2 = f"/home/x_mirpi/Output_TBG/K_{K}2/e_{e}/L{l}_K{K}_e{e}_bmin{beta_low}_bmax{beta_high}/beta_{n}" + '/Helicity_modulus2.txt'
