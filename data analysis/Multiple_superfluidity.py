...
for l in L :
    ...
    for n in range(rank):
        ...
        file_path1 = f"/home/x_mirpi/Output_TBG/K_{K}_tdf/e_{e}/L{l}_K{K}_e{e}_bmin{beta_low}_bmax{beta_high}/beta_{n}" + '/Helicity_modulus1.txt'
        ...
        file_path2 = f"/home/x_mirpi/Output_TBG/K_{K}_tdf/e_{e}/L{l}_K{K}_e{e}_bmin{beta_low}_bmax{beta_high}/beta_{n}" + '/Helicity_modulus2.txt'
...
plt.suptitle(f'Relative density fluctuations K={K}, e={e}')

plt.tight_layout()  # Adjust layout for better appearance
plt.savefig(f'Multiple_superflidity2_K{K}_e{e}.jpg')
