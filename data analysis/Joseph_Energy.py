...
for l in L:
    ...
    for n in range(rank) : 
        ...
        file_path = f"/home/x_mirpi/Output_TBG/K_{K}_first/e_{e}/L{l}_K{K}_e{e}_bmin{beta_low}_bmax{beta_high}/beta_{n}" + '/Joseph_Energy.txt'
        #print(n)
...
plt.ylabel(' Energy ')
plt.title(f'Josephson Energy')
plt.legend()
plt.grid(True)
plt.savefig(f'Interaction_Energy_e={e}_K={K}.jpg')
